...
export default class FarmingPlotFertilizerUtilityAction {
    ...
    handleTick(key, worldState) {
        ...
        if (this.ticks == 0 && this.target.sf == 1) {
            sendCharacterMessage('This already looks fertilized', key, worldState);
            setAnimation(user, 'idle');
            return false;
        }
